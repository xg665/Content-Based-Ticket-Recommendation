...
import Entity.Item.ItemBuilder;
	...
	public class TicketMasterAPI {
	    ...
	    private static final String API_KEY = "Gk4C8GqAKAmgIgioLBtbfttyF9h7Z5HC";
...
//	        }
	    ...
	    public List<Item> search(double lat, double lon, String keyword) {
	    	...
	    	try {
				...
				//We are at client side, TicketMasterAPI is at server side
	    ...
	    public static void main(String args[]) {
	    	...
	    	TicketMasterAPI obj= new TicketMasterAPI();
	    	obj.queryAPI(40, -74);
